...
const tour = read('src/app/components/onboarding/OnboardingTour.tsx');
const tourState = read('src/app/components/onboarding/onboardingTourState.ts');
const workspace = read('src/app/components/shell/Workspace.tsx');
const topbar = read('src/app/components/shell/TopBar.tsx');
const canvas = read('src/app/components/canvas/Canvas.tsx');
