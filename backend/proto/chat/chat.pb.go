...
func (m *ChatResponse) GetPayload() isChatResponse_Payload {
	if m != nil {
		return m.Payload
	}
	return nil
...
func (x *ChatResponse) GetToken() string {
	if x, ok := x.GetPayload().(*ChatResponse_Token); ok {
		return x.Token
	}
	return ""
}
...
func (x *ChatResponse) GetError() string {
	if x, ok := x.GetPayload().(*ChatResponse_Error); ok {
		return x.Error
	}
	return ""
}
...
var file_proto_chat_chat_proto_rawDesc = []byte{
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x63, 0x68, 0x61, 0x74, 0x22, 0x25, 0x0a,
	0x0b, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06,
	0x70, 0x72, 0x6f, 0x6d, 0x70, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x72,
	0x6f, 0x6d, 0x70, 0x74, 0x22, 0x5d, 0x0a, 0x0c, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x73, 0x70,
	...
	0x28, 0x08, 0x52, 0x04, 0x64, 0x6f, 0x6e, 0x65, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c,
	0x6f, 0x61, 0x64, 0x32, 0x40, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x31, 0x0a, 0x04, 0x43, 0x68, 0x61, 0x74, 0x12, 0x11, 0x2e, 0x63, 0x68, 0x61,
	...
	0x65, 0x28, 0x01, 0x30, 0x01, 0x42, 0x14, 0x5a, 0x12, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64,
...
func file_proto_chat_chat_proto_init() {
	...
	file_proto_chat_chat_proto_msgTypes[1].OneofWrappers = []interface{}{
