...
func (x *TaskUpdate) GetIsChat() bool {
	if x != nil {
		return x.IsChat
	}
	return false
...
const file_boss_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"boss.proto\x12\x04boss\"\x93\x02\n" +
	"\n" +
	"TaskUpdate\x12\x17\n" +
	...
	"\x04data\x18\x06 \x03(\v2\x1a.boss.TaskUpdate.DataEntryR\x04data\x12\x17\n" +
	"\ais_chat\x18\a \x01(\bR\x06isChat\x1a7\n" +
	"\tDataEntry\x12\x10\n" +
	...
	"\rcustom_prompt\x18\x03 \x01(\tR\fcustomPrompt\"\x8d\x01\n" +
